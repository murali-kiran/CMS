...
<table cellpadding="0" cellspacing="0" border="0"  style="width: 960px;height:100%; margin-left: auto; margin-right: auto;">
	<tr>
		<td style="width: 660px; padding: 15px; padding-left: 0px; border: 0px; vertical-align: top;">
			<table cellpadding="0" cellspacing="0" border="0" style="width: 100%; height: 100%; padding: 5px;">
				<tr style="height: 70px;">
					<td colspan="2">
						<%-- <img alt="Effort" src="${pageContext.servletContext.contextPath}/resources/images/effort.png"> --%>
					</td>
				</tr>
				<tr style="height: 20px;"><td></td></tr>
				<tr style="height: 80px;">
					<td style="width: 60px;" valign="middle">
						<%-- <img src="${pageContext.servletContext.contextPath}/resources/images/do_more_with_less.png" align="left" style="padding-left: 10px;"/> --%>
					</td>
					<td valign="middle">
				...
				<tr style="height: 80px;">
					<td style="width: 60px;" valign="middle">
					<%-- 	<img src="${pageContext.servletContext.contextPath}/resources/images/guarantee_service.png" align="left" style="padding-left: 10px;"/> --%>
					</td>
					<td valign="middle">
				...
				<tr style="height: 80px;">
					<td style="width: 60px;" valign="middle">
			<%-- 			<img src="${pageContext.servletContext.contextPath}/resources/images/make_right_decisions_quicker.png" align="left" style="padding-left: 10px;"/> --%>
					</td>
					<td valign="middle">
