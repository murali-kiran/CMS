...
<div>
	<c:forEach var="mediaInfo" items="${media.name}">
		<div style="width: 33%; float: left; text-align: center;margin: 2px 0px 2px;">
			...
			<div>
			<a href="${pageContext.servletContext.contextPath}/stv/dwl/${serviceId}/${mediaInfo.mediaId}/${mediaInfo.serviceKeypriceKey}?channel=${channel}&serviceKeyId=${serviceKeyId}&catId=${categoryId}">		<img alt="noImage"
	...
	&nbsp;<a
				href="<c:url value="/stv/cat/pageId/pageCount/${serviceId}/${category.id}/${i}/${PaginationCount}?channel=${channel}&serviceKeyId=${serviceKeyId}"/>">&nbsp;${i}&nbsp;</a>&nbsp;
	</c:forEach>
	</div>
...
<div style="width: 100%;clear: both;"><a href="${pageContext.servletContext.contextPath}/stv/${serviceId}?channel=${channel}&serviceKeyId=${serviceKeyId}">&nbsp;Home</a></div>
