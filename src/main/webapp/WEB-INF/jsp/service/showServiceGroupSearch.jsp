...
<form:form method="post" id="feedbackform" name="feedbackform"  commandName="searchMediaGroup"
                           action="${pageContext.servletContext.contextPath}/showServiceRemMediaGroup" escape="false" enctype="multipart/form-data">
...
<tr>
<td>Media Group Title <input type="hidden" name="serviceId" id="serviceId" value="<%=request.getParameter("srid")%>"/> </td>
