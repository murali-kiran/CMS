...
<div style="text-align: center;margin-bottom:3px;color: black;background-color: yellow;width: 100%;border:1px solid black;"><a href="${pageContext.servletContext.contextPath}/stv/showSearchPage/${serviceId}?channel=smd" style="font-size: 14px;font-weight:bold;">Search</a></div>
