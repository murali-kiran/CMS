...
<div style="text-align: center;font-size: 12;color: black;background-color: yellow;width: 100%;border:1px solid black;">${title}</div>
<div style="background-color: yellow;margin-bottom: 2px;width: 100%;text-align: center;border:1px solid black;"><a href="${pageContext.servletContext.contextPath}/service/showSearchPage/${serviceId}?channel=smd">Search</a></div>
