...
public class HomeController extends BaseController{
	...
	public String getService(Model model,@PathVariable Integer serviceId,HttpServletRequest request){
	...
	public String downloadMedia(HttpServletRequest request,HttpServletResponse response,HttpSession session,Model model,@PathVariable Integer serviceId,@PathVariable Integer mediaId,@PathVariable String serviceKeypriceKey){
		...
		//			serviceLayer.saveFailPurchaseAndPFailPurchaseDetails(request,serviceKeyId,errorCode);
				...
				return "forward:/service/"+serviceId+"?channel="+request.getParameter("channel")+"&msisdn="+session.getAttribute("msisdn").toString()+"&operator="+session.getAttribute("operator").toString();
	...
	public String getServiceByCategory(HttpServletRequest request,Model model,@PathVariable Integer serviceId,@PathVariable Integer catId){
	...
	public String getServiceBySubCategory(HttpServletRequest request,Model model,@PathVariable Integer serviceId,@PathVariable Integer parentCatId,@PathVariable Integer catId){
	...
	public String getServiceByCategorybyPagination(HttpServletRequest request,Model model,@PathVariable Integer serviceId,@PathVariable Integer catId,@PathVariable Integer pageId,@PathVariable Integer pageCount){
